...
public class RecyclerTabPageIndicator extends HorizontalScrollView implements RecyclerPageIndicator {
    ...
    private final com.viewpagerindicator.as.library.indicator.IcsLinearLayout mTabLayout;
    ...
    public RecyclerTabPageIndicator(Context context, AttributeSet attrs) {
        ...
        mTabLayout = new com.viewpagerindicator.as.library.indicator.IcsLinearLayout(context, R.attr.vpiTabPageIndicatorStyle);
