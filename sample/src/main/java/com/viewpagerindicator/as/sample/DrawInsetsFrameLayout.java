    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new android.support.v4.view.OnApplyWindowInsetsListener() {
            ...
            public WindowInsetsCompat onApplyWindowInsets(View v, WindowInsetsCompat insets) {
                mInsets = new Rect(insets.getStableInsetLeft(), insets.getStableInsetTop(),insets.getSystemWindowInsetRight(), insets.getSystemWindowInsetBottom());
...
//
//            mInsets = new Rect(insets.getSystemWindowInsetLeft(), insets.getStableInsetTop(),insets.getSystemWindowInsetRight(), insets.getSystemWindowInsetBottom());
//            if (mOnInsetsCallback != null) {
//                mOnInsetsCallback.onInsetsChanged(mInsets);
//            }
//            return insets;
