 ...
 * also scrolled.
 */
public class RecyclerTitlePageIndicator extends View implements RecyclerPageIndicator {
    /**
...
//    private ViewPager.OnPageChangeListener mListener;
    ...
    public RecyclerTitlePageIndicator(Context context) {
        this(context, null);
    }

    public RecyclerTitlePageIndicator(Context context, AttributeSet attrs) {
