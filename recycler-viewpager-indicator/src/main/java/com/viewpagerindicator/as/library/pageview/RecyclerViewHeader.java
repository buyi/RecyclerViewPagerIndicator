...
//            styledAttributes.recycle();
//            int height = mActionBarSize;
//            System.out.println("setupAlignment height:" + height);
...
//            RecyclerViewHeader.this.setLayoutParams(newHeaderParams);
            ...
            if (currentParent instanceof ViewGroup) {
                ...
                newRootParent.addView(recycler, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
                newRootParent.addView(RecyclerViewHeader.this, newHeaderParams);
...
//
//                System.out.println("onGlobalLayout? height" + height);
//                if (height > 0) {
...
//
//            c.drawLine(0, 20, 100, 20, new Paint());
//
//        }
         ...
         */
        public HeaderItemDecoration(Drawable divider, RecyclerView.LayoutManager layoutManager, int height) {
