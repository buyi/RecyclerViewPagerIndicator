 ...
 */
public class RecyclerLinePageIndicator extends View implements RecyclerPageIndicator {
...
//    private ViewPager mViewPager;
    ...
    public RecyclerLinePageIndicator(Context context) {
        this(context, null);
    }

    public RecyclerLinePageIndicator(Context context, AttributeSet attrs) {
